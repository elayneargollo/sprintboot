...
class AssociadorControllerTest {
	...
	public void GetById() throws Exception {
		...
		mock.perform(get(BASE_URL + "v1.0/" + "1")
	...
	public void GetAll() throws Exception {
		...
		mock.perform(get(BASE_URL + "v1.0/" )
		        .contentType("application/json")
	...
	public void GetAllv11() throws Exception {
		...
		mock.perform(get(BASE_URL + "v1.1/")
		        .contentType("application/json")
		        .content(objectMapper.writeValueAsString(associadosMock)));
	...
	public void GetAdd() throws Exception {
		...
		mock.perform(post(BASE_URL + "/v1.1/")
                .content(objectMapper.writeValueAsString(associadoDtoMock))
